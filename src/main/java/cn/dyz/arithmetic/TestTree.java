...
public class TestTree {
	 ...
	 * @param node
	 */
	public static void interIter(Node node){
		if(node!=null){
	 ...
	 */
	public static Node buildTree(int[] preOrder,int preStartIndex,int preEndIndex,int[] inOrder,int inStartIndex,int inEndIndex){
		Node root = new Node();
